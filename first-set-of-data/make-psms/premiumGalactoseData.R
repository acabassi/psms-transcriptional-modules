...
myData <- read.csv("../data/GalactoseData.csv", row.names = 1)
...
myData <- cbind(outcome, myData) # This is the data file (includes response and
                                 # covariates)
...
prof_regr <-
  profRegr(
    ...
    output = paste0("../premium/galactose_chain", chain),
...
save(prof_regr,
     file = paste0("../premium/galactose_",
...
save(psm, coph_corr,
     file = paste0(
       "../premium/galactose_chain", chain,"_psm_exclude_y_var_sel.RData"))
