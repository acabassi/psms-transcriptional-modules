...
# png(paste0("figures/second_set_of_data_silhouette.png"),
#     height = 550,
#     width = 550)
...
load("data/unsupervised_output.RData")
...
Hclusters <-
    rowAnnotation(
        ...
        name = "Final clusters",
        annotation_legend_param = my_anno_legend_param("Clusters", nrow=3),
...
png(
    paste0("figures/second_set_of_data_weightedKernel_", bestK, "clusters.png"),
    height = 660,
    width = 600
)
draw(
